...
function Projects() {
  ...
  return (
    ...
    >
      ...
      <Title>SELECT YOUR MISSION</Title>
      <div className="flex flex-col gap-6 md:gap-10 max-w-4xl mx-auto w-full flex-1">
        <Display activeProject ={activeProject}  />
        <SelectProject projectsList= {projectsList} selectedProjectIndex ={selectedProjectIndex} setSelectedProjectIndex = {setSelectedProjectIndex}/>
      </div>
    </motion.div>
  );
}
